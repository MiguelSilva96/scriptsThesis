...
# RDMA libraries
sudo apt-get install libibverbs1  libibverbs-dev  librdmacm-dev  librdmacm1  ibverbs-utils  rdmacm-utils ibutils ibsim-utils libcxgb3-1 libibmad5 libibumad3 libmlx4-1 libmthca1 libnes1
